...
const ProductGroup = () => {
  ...
  return (
    <section className=" mb-3" >
      ...
      <div className="d-xl-none d-lg-block shadow p-3 mb-5 bg-white rounded">
        <div className="row">
      ...
      <div className="d-none d-lg-block p-4 mb-6 shadow bg-white rounded" style={{marginBottom:"50%", display:"flex",justifyContent:"space-evenly"}}>
        <div className="row">
          <div className="col-12 col-md-6 col-lg-6">
            <div className="row">
              <div className=" col-3 col-md-3 col-lg-3" onClick={() => setCurrentTab('phones')} >
