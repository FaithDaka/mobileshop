        ...
        <>
            ...
            <div className="d-xl-none d-lg-block z-1020 shadow-sm fixed-top" style={{ background: '#101622' }}>
                <p class="text-center" style={{ background: "white" }}>
                    <strong className="help float-center pr-5 pb-0 mb-0" style={{ fontSize: 18 + "px" }}>Need help placing an order ?</strong><br></br>
                    ...
                    </svg></i> <a href="tel:0751290264" style={{ color: "black", fontSize: 16 + "px" }}>+256 779 003322 </a></span>
                </p>
