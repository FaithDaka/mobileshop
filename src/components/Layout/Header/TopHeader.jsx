        ...
        <div class="mt-1 pt-1 top-navbar bg-white border-bottom border-soft-secondary z-1035 d-none d-lg-block text-center">
            <div class="container">
                ...
                <p className="need-help">
                    ...
                    <span className="help-contact "><i class="bi bi-telephone-outbound-fill pr-1 "><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-telephone-outbound-fill" viewBox="0 0 16 16">
